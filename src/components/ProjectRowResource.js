...
import { PROJECT_RESOURCE } from "../mock/projectConstants";
import DropZone from "./ProjectDropZone";
import ColumnResource from "./ProjectColumnResource";
...
const ProjectRow = ({ data, components, handleDrop, path }) => {
  ...
  const [{ isDragging }, drag] = useDrag({
    ...
    item: {
      type: PROJECT_RESOURCE, // type duplicated here to avoid error on drop into other row
      id: data.id,
